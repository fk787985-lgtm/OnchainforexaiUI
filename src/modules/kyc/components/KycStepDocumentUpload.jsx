...
export default function KycStepDocumentUpload({
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="rounded-xl border border-cyan-100 dark:border-cyan-800/50 bg-cyan-50/70 dark:bg-cyan-950/20 p-3">
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4">
        ...
        <p className="fx-help">Only images (JPEG/PNG/HEIC) and PDF files are allowed for documents.</p>
        ...
        {frontPreviewUrl && isPdf(frontFile) ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-2 inline-flex items-center rounded-lg border border-slate-200 dark:border-slate-700 px-3 py-2 text-sm text-cyan-600 dark:text-cyan-400"
          >
            Open Front PDF
          </a>
        ) : null}
