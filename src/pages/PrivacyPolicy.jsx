          ...
          <section>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
              <p className="text-gray-700 dark:text-gray-300">
                <strong>Email:</strong> {siteSettings.site.contact?.email || 'support@onchainforexai.com'}<br />
                <strong>Support:</strong> {siteSettings.site.contact?.email || 'support@onchainforexai.com'}
              </p>
            </div>
          </section>
        </div>
