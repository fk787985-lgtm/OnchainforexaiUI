...
export default function SubAdminNotifyUsers() {
  ...
  const fetchUsers = async () => {
    try {
      // Sub-admins only get their assigned users
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Send Notification to Assigned Users</h2>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
              Select Assigned Users ({selectedUsers.length} selected)
            </h3>
            <button
          ...
          <div className="mb-4">
            <input
              ...
              placeholder="Search assigned users by name, email, or ID..."
            />
          </div>
